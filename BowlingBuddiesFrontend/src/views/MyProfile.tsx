  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 relative">
        ...
        <main className="w-full max-w-4xl mx-auto mt-3 px-6 sm:px-6 lg:max-w-4hxl lg:mx-20 xl:mx-25 xl:max-w-6xl mxl:max-w-7hxl mxl:mx-25 lxl:mx-50 xxl:max-w-9xl">
          <div className="grid grid-cols-1 md:grid-cols-5 md:gap-x-3 lg:grid-cols-12 lg:gap-4 xl:gap-x-1 mxl:gap-x-4 xxl:grid-cols-24 xxl:gap-4">
