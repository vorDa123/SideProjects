...
function JoinModal(props: ModalProps) {
  ...
  return createPortal(
    <>
      ...
      ></div>
      <div className="bg-white-100 mx-auto my-5 w-9/10 h-[90dvh] fixed top-0 left-0 right-0 z-60 rounded-m30 md:w-8/10 md:h-[95dvh] lg:w-5/10 xl:w-4/10 xxl:w-3/10 xxl:h-[85dvh] flex flex-col overflow-hidden">
