...
function NextFreeSlotCard(props: NextFreeSlotCardProps) {
  ...
  return (
    <>
      ...
      >
        <div className={`w-1/3 rounded-tl-m15 rounded-bl-m15 bg-[url(${props.freeSlotData.bowlingCenterInfo.img})] bg-center bg-cover`}></div>
        <div className="flex flex-col gap-6 md:gap-5 w-2/3 px-2 py-2">
          <p className="text-mh2 font-medium">{props.freeSlotData.bowlingCenterInfo.name}</p>
          <div className="flex flex-col gap-5 md:gap-3">
            <div className="flex flex-row gap-5">
              ...
              <span className="w-1/3">
                <FontAwesomeIcon icon={faClock} /> {props.freeSlotData.startTime}
              </span>
            </div>
            <div className="flex flex-row gap-5">
              <span className="truncate w-2/3">
                <FontAwesomeIcon icon={faLocationDot} /> {props.freeSlotData.bowlingCenterInfo.location}
              </span>
              <span className="w-1/3">
