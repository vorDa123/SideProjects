...
function BowlingCentersDashboard() {
  return (
    <section className="pt-5 pb-2.5 w-full">
      <div className="flex flex-row items-center justify-between">
        <h1 className="text-mh1 w-2/3 md:w-1/2 font-semibold md:text-th2">Bowling Center</h1>
        <input className="border border-darkerBlue-100 rounded-m15 h-5 py-3 px-2 w-1/3 md:w-1/2" type="search" name="search" id="searchDashboard" placeholder="Search..."/>
      </div>
