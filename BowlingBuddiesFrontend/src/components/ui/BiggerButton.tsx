      ...
      <>
        <button
          className={
            props.classOverride
              ? props.classOverride
              : `text-mh1 h-14.75 w-47.5 font-semibold bg-orange-100 py-2 px-8 rounded-m25 text-center cursor-pointer hover:bg-orangeHover-100 focus:border-2 focus:border-darkerBlue-100 active:w-45 active:h-13 ${props.classAppend}`
          }
